...
C:\Windows\SysWOW64\WindowsPowerShell\v1.0\powershell.exe -noexit -command "& {Import-Module '%VSDLL%'; Enter-VsDevShell b6423c22; cd '%TARGET_DIR%'; echo '[2/2] Compiling...'; cl.exe /EHsc launcher.cpp /Fe:launcher.exe}"